-- [[
--
--Makes use of the AwesomeWM config template from github.com/lcpz
--
-- ]]
...
run_once({ 'picom',
           'xrandr --output eDP1 --mode 1092x1080',
	   'nitrogen --restore',
	   'redshift -O 5000',
	   'unclutter -root' })
...
local vi_focus		= false -- vi-like client focus - https://github.com/lcpz/wesome-copycats/issues/275
local cycle_prev	= true -- cycle trough all previous client or just the first --https://github.com/lcpz/awesome-copycats/issues/274
local editor 		= os.getenv('EDITOR') or 'emacs'
local gui_editor	= os.getenv('GUI_EDITOR') or 'emac'
...
local myawesomemenu = {
   ...
   { 'edit config', tring.format('%s -e %s %S', terminal, editor, awesome.conffile) },
...
awful.util.mymainmenu = freedesktop.menu.build({
    ...
    before = {
	{ 'Awesome', myawesomemeny, beautiful.awesome_icon },
...
member.utils.terminal = terminal
-- }}}
...
globalkeys = gears.table.join(
    -- Take a screenshot (https://github.com/lcpz/dos/blob/master/bin/screenshot)
    awful.key({ ALT		  }, 'p', function() os.execute('screenshot') end,
    	      {description = 'take a screenshot', group = 'hotkeys'}),
    -- X screen locker
    awful.key({ ALT		  }, 'l', function() os.execute(scrlock) end,
    ...
    -- Program Launcher Keybindings
    awful.key({ modkey, "Control" }, "f",     function () awful.util.spawn("firefox") end,
          {description = "firefox", group = "programs"}),
    awful.key({ modkey, "Control" }, "s",     function () awful.util.spawn("signal-desktop") end,
          {description = "signal", group = "social"}),
    awful.key({ modkey, "Control" }, "d",     function () awful.util.spawn("discord") end,
          {description = "discord", group = "social"}),
    awful.key({ modkey, "Control" }, "c",     function () awful.util.spawn("code") end,
          {description = "code", group = "programs"}),
    ...
    awful.key({ modkey, "Control" }, "t",     function () awful.util.spawn("thunderbird") end,
          {description = "thunderbird", group = "social"}),
    awful.key({ modkey, "Control" }, "p",     function () awful.util.spawn("pcmanfm") end,
          {description = "pcmanfm", group = "programs"}),
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "q",      function (c) c:kill()                         end,
              {description = "close program", group = "client"}),
